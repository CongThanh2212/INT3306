                ...
                <ul id="menu">
                    <li>
                        ...
                        <ul>
                            ...
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Nhập vào kho</li>
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Xuất đi</li>
                        </ul>
                    </li>
                    <li>
                        <a href="#!" onClick={this.show} onMouseOver={this.hover} onMouseOut={this.unHover}>Sản phẩm lỗi - cũ</a>
                        <ul>
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Thông báo</li>
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Đã tiếp nhận</li>
                        </ul>
                    </li>
                    <li>
                        <a href="#!" onClick={this.show} onMouseOver={this.hover} onMouseOut={this.unHover}>Thống kê sản phẩm</a>
                        <ul>
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Trạng thái</li>
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Đã bán</li>
                            <li onClick={this.showChange} onMouseOver={this.hover} onMouseOut={this.unHover}>Lỗi</li>
                        </ul>
                    </li>
                    <li>
